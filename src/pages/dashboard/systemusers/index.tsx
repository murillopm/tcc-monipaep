          ...
          <>
            ...
            <Flex mx="8" mb="8">
              <InputGroup w="30">
                ...
                <Input placeholder="Buscar pelo nome..." onChange={debouncedChangeInputHandler}/>
              </InputGroup>       
            </Flex>
                    ...
                    <Tr key={systemUser.systemUser.id} _hover={{ bgColor: 'gray.50' }}>
                      <Td>
                        <Box textAlign="left">
                          ...
                          <Text fontSize="sm" color="gray.500">{systemUser.systemUser.email}</Text>
                        </Box>
                      </Td>
                      <Td>
                        <Badge colorScheme={systemUser.systemUser.department === 'USM' ? 'purple' : 'orange'}>
                          {systemUser.systemUser.department === 'USM' ? 'Unidade de Saúde' : 'Vigilância em Saúde'}
                        </Badge>
                      </Td>
                      <Td>
